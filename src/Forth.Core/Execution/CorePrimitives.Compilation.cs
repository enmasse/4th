...
internal static partial class CorePrimitives
{
    static partial void AddCompilationEntries(Dictionary<(string? Module, string Name), ForthInterpreter.Word> d)
    {
        ...
        d[(null, ";")] = new(i => { i.FinishDefinition(); return Task.CompletedTask; }) { IsImmediate = true, Name = ";" };

        d[(null, "IMMEDIATE")] = new(i =>
        {
        ...
        d[(null, "[")] = new(i => { i._isCompiling = false; i._mem[i.StateAddr] = 0; return Task.CompletedTask; }) { IsImmediate = true, Name = "[" };
        d[(null, "]")] = new(i => { i._isCompiling = true; i._mem[i.StateAddr] = 1; return Task.CompletedTask; }) { IsImmediate = true, Name = "]" };

        d[(null, "IF")] = new(i => { i._controlStack.Push(new Forth.Core.Interpreter.ForthInterpreter.IfFrame()); return Task.CompletedTask; }) { IsImmediate = true, Name = "IF" };
        d[(null, "ELSE")] = new(i =>
        {
        ...
        d[(null, "BEGIN")] = new(i => { i._controlStack.Push(new Forth.Core.Interpreter.ForthInterpreter.BeginFrame()); return Task.CompletedTask; }) { IsImmediate = true, Name = "BEGIN" };
        d[(null, "WHILE")] = new(i =>
        {
        ...
        d[(null, "DO")] = new(i => { i._controlStack.Push(new Forth.Core.Interpreter.ForthInterpreter.DoFrame()); return Task.CompletedTask; }) { IsImmediate = true, Name = "DO" };
        d[(null, "LOOP")] = new(i =>
        {
