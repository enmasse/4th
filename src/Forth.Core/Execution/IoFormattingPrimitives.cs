...
internal static class IoFormattingPrimitives
{
    ...
    private static Task Prim_DotS(ForthInterpreter i)
    {
        ...
        for (int idx = 0; idx < items.Count; idx++)
        {
            ...
            switch (o)
            {
                ...
                case int ii: sb.Append(ii.ToString(System.Globalization.CultureInfo.InvariantCulture)); break;
                case short s: sb.Append(((long)s).ToString(System.Globalization.CultureInfo.InvariantCulture)); break;
                case byte b: sb.Append(((long)b).ToString(System.Globalization.CultureInfo.InvariantCulture)); break;
                case char ch: sb.Append((int)ch); break;
                case bool bo: sb.Append(bo ? -1 : 0); break;
                default: sb.Append(o?.ToString() ?? "null"); break;
            }
        }
    ...
    private static Task Prim_WORDS(ForthInterpreter i)
    {
        ...
        int lineWidth;
        try { lineWidth = Console.WindowWidth; } catch { lineWidth = 80; }
