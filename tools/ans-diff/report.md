...
## Other primitives in code not in tracked sets (99)
-, -ROT, :NONAME, ['], [CHAR], *, */, /, /MOD, +, +!, <, <=, <>, =, >, >=, >FLOAT, >UNUMBER, 0<>, 0=, 2DUP, 2OVER, 2SWAP, ADD-INPUT-LINE, AGAIN, AND, BIN, BIND, CHAR, CLOSE-BLOCK-FILE, COPY-FILE, D., D>F, DEPTH, DF!, DF@, DROP, DUP, END-MODULE, ENV, EVALUATE, EXECUTE, F!=, F**, F<=, F>, F>=, F>D, F0<=, F0>, F0>=, FDEPTH, FDROP, FDUP, FIND, FLOATS, FLUSH-BLOCK-FILE, FOVER, FROT, FS., FSWAP, HELP, IL{, INVERT, LAST-STORE, LATEST, LOAD-ASM, LOAD-ASM-TYPE, LOAD-FILE, LSHIFT, M+, MAX, MIN, MOD, MODULE, NEGATE, OPEN-BLOCK-DIR, OPEN-BLOCK-FILE, OR, OVER, PICK, R/O, R/W, READ-FILE-BYTES, REPORT-ERRORS, ROT, RP@, RSHIFT, RUN-NEXT, S, SF!, SF@, SWAP, USING, W/O, WRITE-FILE-BYTES, XOR, YIELD
